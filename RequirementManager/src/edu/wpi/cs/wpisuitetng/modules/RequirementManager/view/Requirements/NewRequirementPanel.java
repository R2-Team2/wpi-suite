...
public class NewRequirementPanel extends JPanel {
	...
	public NewRequirementPanel() {
		...
		layout.putConstraint(SpringLayout.NORTH, labelName, 15,
				SpringLayout.NORTH, leftPanel);
		layout.putConstraint(SpringLayout.WEST, labelName, 15,
				SpringLayout.WEST, leftPanel);

		layout.putConstraint(SpringLayout.NORTH, boxName, 15,
				SpringLayout.SOUTH, labelName);
		layout.putConstraint(SpringLayout.WEST, boxName, 15, SpringLayout.WEST,
				leftPanel);

		layout.putConstraint(SpringLayout.NORTH, labelDescription, 15,
				SpringLayout.SOUTH, boxName);
		layout.putConstraint(SpringLayout.WEST, labelDescription, 15,
				SpringLayout.WEST, leftPanel);

		layout.putConstraint(SpringLayout.NORTH, boxDescription, 15,
				SpringLayout.SOUTH, labelDescription);
		layout.putConstraint(SpringLayout.WEST, boxDescription, 15,
				SpringLayout.WEST, leftPanel);

		layout.putConstraint(SpringLayout.NORTH, testField, 15,
				SpringLayout.SOUTH, boxDescription);
		layout.putConstraint(SpringLayout.WEST, testField, 15,
				SpringLayout.WEST, leftPanel);
		...
		String[] statusString = { "Not Selected", "New", "In Progress", "Open",
				"Complete", "Delete" };
		...
		buttonCancel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				testField.setText(null);
			}
		});

		buttonDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				testField.setText("Delete");
			}
		});
