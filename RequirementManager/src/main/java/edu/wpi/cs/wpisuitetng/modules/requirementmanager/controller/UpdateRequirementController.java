...
public class UpdateRequirementController {
    ...
    /**
     * @return the instance of the UpdateRequirementController or creates one if it does not exist.
     */
     ...
     */
    public static void setInstance(UpdateRequirementController instance) {
        UpdateRequirementController.instance = instance;
    }
