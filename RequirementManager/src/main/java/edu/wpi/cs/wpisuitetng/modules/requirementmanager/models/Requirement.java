...
public class Requirement extends AbstractModel {
    ...
    public void setType(RequirementType type) {
        if ((type != this.type) && (!wasCreated)) {
            ...
            if (originalType.isEmpty())
                ...
                message = ("Type changed from '" + originalType + "' to '" + newType + "'");
            this.history.add(message);
        }
        this.type = type;
    }
     ...
     * 
     * @param parentId The ID of the parent requirement @return true if the
     ...
     * 
     * @param childId ID of the child @return true if it is an ancestor of the
     *            child
     */
     ...
     * 
     * @param parentReq @throws Exception if invalid parent
     */
     ...
     * 
     * @param json
     *            string containing a JSON-encoded array of Requirement @return
     *            an array of Requirement deserialized from the given JSON
     *            string
     */
     ...
     * 
     * @return true if the status of the requirement is deleted and false
     *         otherwise.
     */
