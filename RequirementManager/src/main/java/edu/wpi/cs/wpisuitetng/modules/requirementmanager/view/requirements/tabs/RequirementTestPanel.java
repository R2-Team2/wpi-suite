...
public class RequirementTestPanel extends JPanel implements RequirementPanelListener {
    ...
    static final long serialVersionUID = -4854352702064502285L;
     ...
     */
    @Deprecated
    public RequirementTestPanel(@SuppressWarnings("unused") RequirementTabsPanel parent, ViewMode vm, Requirement current) {
        this(vm, current);
    }
    
    public RequirementTestPanel(ViewMode vm, Requirement current) {
        ...
        bottomPanel.add(buttonAddTest, bc); // Include "Add note" button to bottom panel
    ...
    /**
     * Method readyToRemove. @return boolean
     * 
     ...
     */
    void setTestTitle(JTextField testTitle) {
     ...
     */
    void setTestMessage(JTextArea testMessage) {
        this.testMessage = testMessage;
    }
    
    /**
     * @param testsAdded the testsAdded to set
     */
    void setTestsAdded(int testsAdded) {
