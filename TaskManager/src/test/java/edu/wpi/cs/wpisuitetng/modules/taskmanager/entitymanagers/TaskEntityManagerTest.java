...
public class TaskEntityManagerTest {
    ...
    public void setUp() throws Exception {
        ...
        task1 =
                new Task(0, "Task 1", "to be stored", 0, 0, null, null, null, null, null, null,
                        null);
        task2 =
                new Task(0, "Task 2", "to be stored", 0, 0, null, null, null, null, null, null,
                        null);
        task3 =
                new Task(0, "Task 3", "to be stored", 0, 0, null, null, null, null, null, null,
                        null);

        task4 =
                new Task(4, "Task 4", "to be retrieved", 0, 0, null, null, null, null, null, null,
                        null);
        task5 =
                new Task(5, "Task 5", "to be retrieved", 0, 0, null, null, null, null, null, null,
                        null);
        task6 =
                new Task(6, "Task 6", "to be retrieved", 0, 0, null, null, null, null, null, null,
                        null);
    ...
    public void testDeleteEntity() throws WPISuiteException {
        ...
        when(db.delete(isA(Task.class))).thenReturn(
                new Task(0, null, null, 0, 0, null, null, null, null, null, null, null));
