...
public class RetrieveUsersController {
    ...
    /**
     * If given a filter, RetrieveUsersController will disallow these from the list model
     * 
     * @param model The list model for retrieved users to be put in
    ...
    /**
     * Calling this method sends a request to the database to retrieve all Users.
     */
    ...
    /**
     * Calling this method sends a request to the database to retrieve the User with the given
     * username
     * 
    ...
    /**
     * Populates the model list provided initially with the users retrieved from the database. This
     * method is called by the request observer with the response from the server.
     * 
