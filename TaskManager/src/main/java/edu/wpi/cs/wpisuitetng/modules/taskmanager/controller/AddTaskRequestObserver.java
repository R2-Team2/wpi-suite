...
public class AddTaskRequestObserver implements RequestObserver {
     ...
     * (non-Javadoc)
     * @see
     * edu.wpi.cs.wpisuitetng.network.RequestObserver#responseError(edu.wpi.cs.wpisuitetng.network
     * .models.IRequest)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * edu.wpi.cs.wpisuitetng.network.RequestObserver#fail(edu.wpi.cs.wpisuitetng.network.models
     * .IRequest, java.lang.Exception)
     */
    @Override
