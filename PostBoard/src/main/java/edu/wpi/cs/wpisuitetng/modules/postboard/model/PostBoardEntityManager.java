...
public class PostBoardEntityManager implements EntityManager<PostBoardMessage> {
     ...
     */
    @Override
    public PostBoardMessage makeEntity(Session s, String content) throws BadRequestException, ConflictException, WPISuiteException {
     ...
     */
    @Override
    public PostBoardMessage[] getEntity(Session s, String id) throws NotFoundException, WPISuiteException {
     ...
     */
    @Override
    public PostBoardMessage update(Session s, String content) throws WPISuiteException {
