...
public class TestProjectManager {
    ...
    ProjectManager test = new ProjectManager(MockDataStore.getMockDataStore());
    ProjectManager testWithRealDB = new ProjectManager(DataStore.getDataStore());

    Project tempProject = new Project("test", "8");
    Project delete1 = new Project("test2", "10");
    Project delete2 = new Project("test3", "1");
    Project updateTemp = new Project("0", "proj0");
    Project conflict = new Project("test", "5");

    Gson json = new Gson();

    User tempUser = new User("name", "username", "password", 1);

    Project add1 = new Project("add1", "11");
    Project add2 = new Project("add2", "12");

    String mockSsid = "abc123";
    Session tempSession = new Session(tempUser, mockSsid);

    @Before
    public void setUp() throws WPISuiteException {
        tempUser.setRole(Role.ADMIN);
        tempProject.setPermission(Permission.WRITE, tempUser);
    ...
    public void testMakeEntity() throws WPISuiteException {
        ...
        Session session = new Session(tempUser, mockSsid);
        tempProject.setPermission(Permission.WRITE, tempUser);
        tempProject.setOwner(tempUser);

        String projectJson = tempProject.toJson();
        project = test.makeEntity(session, projectJson);

        assertEquals(tempProject, project);
    }
    ...
    public void testSaveFail() throws WPISuiteException {
        new ProjectManager(new Data() {
            ...
            @Override
            public List<Model> retrieve(Class<?> anObjectQueried, String aFieldName, Object theGivenValue, Project theProject) throws WPISuiteException {
                // TODO Auto-generated method stub
                return null;
            }
    ...
    public void testDeleteEntityFail() throws WPISuiteException {
        ...
        }).deleteEntity(null, tempProject.getIdNum());
    }
    ...
    public void testDeleteEntity() throws WPISuiteException {
        new ProjectManager(new Data() {
            ...
            @Override
            public List<Model> retrieve(Class<?> anObjectQueried, String aFieldName, Object theGivenValue) throws WPISuiteException {
                // TODO Auto-generated method stub
                return null;
            }
            ...
            @Override
            public void update(Class<?> anObjectToBeModified, String fieldName, Object uniqueID, String changeField, Object changeValue) throws WPISuiteException {
                // TODO Auto-generated method stub
        ...
        }).deleteEntity(tempSession, tempProject.getIdNum());
    }
