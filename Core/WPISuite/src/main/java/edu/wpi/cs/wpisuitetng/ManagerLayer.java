 ...
 * entity managers eagerly initialized, the instance of this class is thread safe, provided all
 * methods are thread safe Remember Thread Safety All methods must be thread safe
 */
public class ManagerLayer {
    ...
    private ManagerLayer()
    {
        ...
        // map.put("taskmanager" + "task", new TaskEntityManager(data)); // may not need this
    ...
    /**
     * initializes the database initializes the JSON serializer Accepts a map that will be used
     * instead of the automatically generated map THIS IS FOR TESTING PURPOSES ONLY
     */
    @SuppressWarnings("rawtypes")
    ...
    protected static ManagerLayer getTestInstance(
            @SuppressWarnings("rawtypes") Map<String, EntityManager> map, SessionManager ses)
    {
            ...
            throws WPISuiteException
    {
        ...
        Model m;
        m = map.get(args[0] + args[1]).makeEntity(s, content);
            ...
            throws WPISuiteException
    {
        ...
        Model m;
        m = map.get(args[0] + args[1]).update(s, content);
    ...
    /**
     * Advanced Put ********************** A note about advanced put. the content body should not
     ...
     */
    public String advancedPut(String[] args, String content, Cookie[] cook)
            throws WPISuiteException
    {
        Session s = getSessionFromCookies(cook);
     ...
     * @throws WPISuiteException
     */
    public String advancedPost(String[] args, String content, Cookie[] cook)
            throws WPISuiteException
    {
        Session s = getSessionFromCookies(cook);
            ...
            UnauthorizedException
    {
        ...
        else
        {
            throw new AuthenticationException(
                    "Could not find WPISuite cookie. Please Login to recieve one.");
        }
